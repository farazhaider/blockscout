    ...
    test "returns results in reverse chronological order by block number, transaction index, internal transaction index" do
      ...
      %InternalTransaction{id: first_pending} =
        insert(
          ...
          transaction_block_number: pending_transaction.block_number
        )
      ...
      %InternalTransaction{id: first} =
        insert(
          ...
          transaction_block_number: first_a_transaction.block_number
        )
      ...
      %InternalTransaction{id: third} =
        insert(
          ...
          transaction_block_number: second_a_transaction.block_number
        )
      ...
      %InternalTransaction{id: fifth} =
        insert(
          ...
          transaction_block_number: first_b_transaction.block_number
        )
  ...
  describe "stream_unfetched_balances/2" do
    ...
    test "an address_hash used for multiple block_numbers returns all block_numbers" do
      ...
      insert(
        ...
        transaction_block_number: from_internal_transaction_transaction.block_number
      )
      ...
      insert(
        ...
        transaction_block_number: to_internal_transaction_transaction.block_number
      )
